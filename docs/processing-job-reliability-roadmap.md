...
- **P5c 生产候选演练包**：生成脱敏上线记录模板、旧/新 release 和回滚检查单，验证不可变 release、维护/备份/
  worker 顺序与只读 smoke；不连接生产。
...
| P5 | 进行中（P5c） | P5a/P5b 已完成候选 release、隔离 migration、本地负载和有边界浏览器验收；下一步准备脱敏生产候选演练包，生产部署仍需用户明确授权 |
