...
export const AUDIT_ACTION_LABELS: Record<AuditActionName, string> = {
  ...
  annotation_review_link_create: "关联审核包",
  annotation_review_link_revoke: "撤销审核包关联",
  ...
  media_audio_track_create: "关联媒体音轨",
  media_audio_track_update: "更新媒体音轨",
  media_audio_track_delete: "移除媒体音轨",
  ...
  processing_job_request_cancel: "取消个人任务请求",
  processing_job_force_cancel: "管理员强制取消任务",
  processing_job_retry: "重试后台任务",
  job_create: "创建后台任务",
